  ...
  if (date("Y-m-d", $appdate1) >= $cur_date) {
    if ((date("Y-m-d", $appdate1) == $cur_date and date("H:i:s", $apptime1) > $cur_time) or date("Y-m-d", $appdate1) > $cur_date) {
      ...
      if (mysqli_num_rows($check_query) == 0) {
        $query = mysqli_query($con, "insert into appointmenttb(pid,fname,lname,gender,email,contact,doctor,docFees,appdate,apptime,userStatus,doctorStatus,paymentmode,paidamount,transactionid,approvalstatus) values
        ($pid,'$fname','$lname','$gender','$email','$contact','$doctor','$docFees','$appdate','$apptime','1','1','$paymentmode',$paidamount,'$transactionid','pending')");

        // var_dump("insert into appointmenttb(pid,fname,lname,gender,email,contact,doctor,docFees,appdate,apptime,userStatus,doctorStatus,paymentmode,paidamount,transactionid,approvalstatus) values
        // ($pid,'$fname','$lname','$gender','$email','$contact','$doctor','$docFees','$appdate','$apptime','1','1','$paymentmode',$paidamount,'$transactionid','pending')");
        // exit;
...
<body style="padding-top:50px;">
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                      ...
                      <div class="col-md-8">
                        ...
                        <select name="apptime" class="form-control" id="apptime" required="required">
                          ...
                          <option value="08:00:00">8:00-8:15 AM</option>
                          <option value="08:15:00">8:15-8:30 AM</option>
                          <option value="08:30:00">8:30-8:45 AM</option>
                          <option value="08:45:00">8:45-9:00 AM</option>
                          <option value="09:00:00">9:00-9:15 AM</option>
                          <option value="09:15:00">9:15-9:30 AM</option>
                          <option value="09:30:00">9:30-9:45 AM</option>
                          <option value="10:00:00">10:00-10:15 AM</option>
                          <option value="10:15:00">10:15-10:30 AM</option>
                          <option value="10:30:00">10:30-10:45 AM</option>
                          <option value="10:45:00">10:45-11:00 AM</option>
                          <option value="12:00:00">12:00-12:15 PM</option>
                          <option value="12:15:00">12:15-12:30 PM</option>
                          <option value="12:30:00">12:30-12:45 PM</option>
                          <option value="12:45:00">12:45-1:00 PM</option>
                          <option value="02:00:00">2:00-2:15 PM</option>
                          <option value="02:15:00">2:15-2:30 PM</option>
                          <option value="02:30:00">2:30-2:45 PM</option>
                          <option value="02:45:00">2:45-3:00 PM</option>
                          <option value="03:00:00">3:00-3:15 PM</option>
                          <option value="03:15:00">3:15-3:30 PM</option>
                          <option value="03:30:00">3:30-3:45 PM</option>
                          <option value="03:45:00">3:45-4:00 PM</option>
                          <option value="04:00:00">4:00-4:15 PM</option>
                          <option value="04:15:00">4:15-4:30 PM</option>
                          <option value="04:30:00">4:30:4:45 PM</option>
                          <option value="04:45:00">4:45-5:00 PM</option>
                          
                       </select>

                      </div><br><br>

                      <div class="col-md-4"><label for="doctor">Payment Mode:</label></div>
                      <div class="col-md-8">
                        <select name="paymentmode" class="form-control" id="paymentmode" required="required">
                          <option value="" disabled selected>Select Payment Mode</option>
                          <option value="paynow">Pay Now</option>
                          <option value="paylater">Pay Later/CASH</option>
                        </select>
                      </div><br /><br />
                      
                        <div class="col-md-4" id="paymentdiv1"><label for="qrcode">&nbsp;</label></div>
                        <div class="col-md-8" id="paymentdiv2">
                          <img src="images/qrcode.jpg" style="width:256px;height:345px; display: block;margin-left: auto;
                                          margin-right: auto;">
                        </div><br /><br />

                        <div class="col-md-4" id="paymentdiv3"><label for="transactionid">UPI Transaction Id:</label></div>
                        <div class="col-md-8" id="paymentdiv4">
                          <input class="form-control" type="text" name="transactionid" id="transactionid" />
                        </div><br><br>
            ...
            <table class="table table-hover">
              <thead>
                <tr>
                  ...
                  <th scope="col">UPI Transaction Id</th>
              ...
              <tbody>
                ...
                $query = "select ID,doctor,docFees,appdate,apptime,userStatus,doctorStatus,paymentmode,paidamount,transactionid,approvalstatus from appointmenttb where fname ='$fname' and lname='$lname';";
  ...
  <script>
    $(document).ready(function() {
      $('#paymentdiv1,#paymentdiv2,#paymentdiv3,#paymentdiv4').hide();
      $('#paymentmode').change(function() {
        if ($(this).val() === 'paynow') {
          $('#paymentdiv1,#paymentdiv2,#paymentdiv3,#paymentdiv4').show();
