              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <td>
                      <a href="changepaymentstatus.php?id=<?php echo $row['ID'];?>&status=<?php echo $row['approvalstatus']; ?>" 
                         title="Change Payment Status"
                         onclick="return confirm('Are you sure want to change the payment status ?')"
                      >
                      <?php 
                    ...
                    <td>
                    <a href="changepmtstatus.php?id=<?php echo $row['ID'];?>" 
                         title="Change Payment Status to Paid"
                         onclick="return confirm('Are you sure want to change the payment status to paid ?')"
                      >
                      <?php 
                        if($row['paymentmode'] == 'paylater'){
                          echo 'Pay';
                        }
                      ?>
                      </a>
          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Entomologist" name="spec">Entomologist</option>
                      <option value="Gynecologist" name="spec">Gynecologist</option>
                      <option value="Opthalmologist" name="spec">Opthalmologist</option>
                      <option value="Psychiatrist" name="spec">Psychiatrist</option>
                      <option value="surgeon" name="spec">surgeon</option>
